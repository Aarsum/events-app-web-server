        ...
        stage('Stage 2') {
         ...
         stage('Stage 4') {
            steps {
                ...
                sh "gcloud builds submit -t gcr.io/roidtc-march218/web-server-image-j:v3.${env.BUILD_ID} ."
            }
        }        
         stage('Stage 5') {
            steps {
                ...
                echo "gcr.io/roidtc-march218/web-server-image-j:3.${env.BUILD_ID}"
                sh "kubectl set image deployment/demo-ui demo-ui=gcr.io/roidtc-march218/web-server-image-j:v3.${env.BUILD_ID} --record"
            }
        }
    }
}
